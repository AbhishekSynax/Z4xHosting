...
# --- Configuration ---
TOKEN = '7182319489:AAGHLeeEMg64U79uexydK6-ow3xctddY-xs' # Replace with your actual token
OWNER_ID = 6068463116 # Replace with your Owner ID
ADMIN_ID = 6068463116 # Replace with your Admin ID (can be same as Owner)
YOUR_USERNAME = '@synaxchatrobot' # Replace with your Telegram username (without the @)
UPDATE_CHANNEL = '@synaxbotz' # Replace with your update channel link
...
# File upload limits
FREE_USER_LIMIT = 1
SUBSCRIBED_USER_LIMIT = 5 # Changed from 10 to 15
ADMIN_LIMIT = 20       # Changed from 50 to 999
